...
tWindowArr = 450; %days pcast nominal arrival
tStepDep = 10; % departure survey resolution
tStepArr = 10; % arrival survey resolution
...
V_inf_Elevels =[20:50]; %[1.5,1.8,2.0,2.1,2.2,2.3,2.4,2.5,2.6,2.7,2.8,2.9,3.0,3.5,4.0,5.0,6.0,7.0,8.0,9:20];
TOF_levels = [10:5:50]; %[100:100:500]; %[100:100:600];
V_inf_Mlevels = [20:50]; %[1.5,1.8,2.0,2.1,2.2,2.3,2.4,2.5,2.6,2.7,2.8,2.9,3.0,3.5,4.0,5.0,6.0,7.0,8.0,9:20];
...
title( 'Earth-to-Mars: v_{\infty Earth} ','FontSize',12)
